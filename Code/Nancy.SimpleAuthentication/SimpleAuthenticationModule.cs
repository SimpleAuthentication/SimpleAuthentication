...
namespace Nancy.SimpleAuthentication
{
    public class SimpleAuthenticationModule : NancyModule
    {
            ...
            ICache cache = null)
        {
            ...
            Get[RedirectRoute] = parameters => RedirectToProviderAsync(parameters);
        ...
        private Response RedirectToProviderAsync(dynamic parameters)
        {
        ...
        private async Task<dynamic> AuthenticateCallbackAsync()
        {
            ...
            return _providerCallback.Process(this, model);
        }
