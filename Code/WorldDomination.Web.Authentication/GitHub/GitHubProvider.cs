namespace WorldDomination.Web.Authentication.GitHub
{
    ...
    public class GitHubProvider : IAuthenticationProvider
    {
        ...
        public GitHubProvider(ProviderKey providerKey, IRestClientFactory restClientFactory = null)
            : this(providerKey.Key, providerKey.Secret, restClientFactory)
        {
        }

        
        public GitHubProvider(string clientId, string clientSecret, IRestClientFactory restClientFactory = null)
        {
